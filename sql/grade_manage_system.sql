...
CREATE TABLE `gm_teacher`  (
                             `id` int(11) NOT NULL AUTO_INCREMENT,
                             `workNo` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '工号',
                             `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓名',
                             `loginId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登陆账号',
                             `password` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登陆密码',
                             `sex` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '性别',
                             `birthday` datetime(0) DEFAULT NULL COMMENT '出生日期',
                             `hiredate` datetime(0) DEFAULT NULL COMMENT '入职日期',
                             `position` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '职称',
                             `phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '联系电话',
                             `createAt` datetime(0) DEFAULT NULL,
                             `updateAt` datetime(0) DEFAULT NULL,
                             `role` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '角色，班主任classTeacher，系统管理员sysAdmin,教务管理员eduAdmin，教学领导teachLeader',
                             `isDelete` int(11) DEFAULT NULL COMMENT '是否删除，1：删除，0：未删除',
                             `classId` int(11) COMMENT '班级Id',
                             PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
--超管账号
...
CREATE TABLE `user_module`  (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `moduleName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '模块名称',
...
CREATE TABLE `user_role`  (
                            `id` int(11) NOT NULL AUTO_INCREMENT,
                            `roleName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '角色名',
                            `moduleIds` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '模块Ids',
                            PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
